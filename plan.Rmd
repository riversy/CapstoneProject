...
In this function I will split corpus into sentences. After that I will remove all non character symbols and punctuation. Then I will lowercase that and remove possible profanity words. 

??? Probably I will apply the stemming and tokenization on that step. 
...
profanityDictionary <- "http://www.cs.cmu.edu/~biglou/resources/bad-words.txt"
...
for (rawCorpusFile in list.files("data/en_US")){
  ...
  while (length(lines) > 0){
    ...
    cleanLine <- cleanShortCorpus(lines)
    writeLines(cleanLine, con = clean)
